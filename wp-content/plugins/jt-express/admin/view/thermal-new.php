	...
	<head>
		...
		<style type="text/css">
			...
			#dispatcherCopy {
				...
				display: grid;
				grid-template-columns: 1fr;
				grid-template-rows: 1.1fr 0.5fr 1fr 0.6fr 0.9fr 0.1fr;
				grid-template-areas:
			...
			#senderCopy {
				...
				display: grid;
				grid-template-columns: 1fr;
				grid-template-rows: 1fr 0.5fr 0.2fr 1.5fr 0.1fr;
				grid-template-areas:
					"senderCopyBarcode"
					"senderDetailsTo"
					"senderDetailsFrom"
			...
			<div id="receiverCopy">
				...
				<div id="receiverCopyRow2">
					...
					<div id="receiverCopyRow2Details">
						...
						<div class="DetailsPhone"><?= $this->phone_format($receiver_phone) ?></div>
				...
				<div id="receiverCopyRow3">
					...
					<div class="awbInfoDetails">
						...
						<div class="DetailsPhone"><?= $this->phone_format($setting['phone']) ?></div>
						<div class="DetailsAddress" style="height: 39px;"></div>
					</div>
				</div>
			...
			<div id="senderCopy">
				...
				<div id="senderDetailsFrom">
					...
					<div class="senderFromDetails">
						<div class="DetailsName"><?= $setting['name']; ?></div>
						<div class="DetailsPhone"><?= $this->phone_format($setting['phone']); ?></div>
						<div class="DetailsAddress" style="height: 24px;"></div>
					</div>
				</div>
				<div id="senderInfoDetails">
					<div id="senderInfoDetailsComplicated">
						<div id="senderInfoDetailsComplicatedParcelInfo">
							<div id="parcelInfoDetailsSender" style="height: 75px; margin-left: 3px">
								<?php
								if ($setting['goods'] == 'yes') {
									foreach ($item_name as $key => $value) {
										echo $value . str_repeat('&nbsp;', 3);
