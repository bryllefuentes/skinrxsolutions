                        ...
                        ">
                         <div class="uimrow">
                             ...
                             <div class="uiminput 
								...
								?>
                                ">
                                 <input type="number" name="group_limit" min="0" id="group_limit" value="<?php
									if ( !empty( $row ) ) {
...
<div class="uimrow">
       ...
       <div class="uiminput">
         ...
         <div class="uimnote"><?php esc_html_e( "Displays the Vendor Dashboard tab on the user profile page with all the vendor details in one place. Visible only on user's own profile.", 'profilegrid-user-profiles-groups-and-communities' ); ?>         
             <a href="https://profilegrid.co/woocommerce-plans/" target="_blank"><?php esc_html_e( 'Enable this feature', 'profilegrid-user-profiles-groups-and-communities' ); ?></a>
...
<?php endif; ?> 
    ...
    <div class="pg-woo-core-offer-banner pg-getpg-banner-core">
        <div class="pg-woo-banner-wrap pg-box-border pg-box-h-100 pg-box-white-bg pg-box-row">
            <div class="pg-woo-banner-content pg-box-p-0 pg-box-col-12">
                <a href="https://profilegrid.co/woocommerce-plans/" target="_blank" rel="noopener"><img src="<?php echo esc_url( $path . 'images/svg/pg-woo-banner.svg' ); ?>" class="" alt="Offer banner"></a>
            </div>
        </div>
    </div>
