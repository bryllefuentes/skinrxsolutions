...
if (!class_exists('WPKQCG_Metabox_qrcodemetabox'))
{
	class WPKQCG_Metabox_qrcodemetabox
	{
		...
		public function render_meta_box_content($post)
		{
			...
			$qrcodeNoticeHTML .= '<br />';
			$qrcodeNoticeHTML .= sprintf(__('This shortcode generator assistant is also available in %1$sthe plugin options page%2$s.', WPKQCG_TEXT_DOMAIN), '<a href="' . esc_url(admin_url('admin.php?page=' . WPKQCG_Admin_Dashboard::$_pageSlug)) . '">', '</a>');
			$qrcodeNoticeHTML .= '</p>';
